...
Route::controller(TeacherController::class)->middleware('teacher','auth')->group(function () {
    ...
    //Reporting route
    Route::get('teacher/reporting', 'reportingList')->name('teacher.reporting');
    Route::get('teacher/reporting/create_modal', 'createReportingModal')->name('teacher.reporting.open_modal');
    Route::post('teacher/reporting', 'reportingCreate')->name('teacher.reporting.create');
    Route::get('teacher/reporting/card/{id}', 'reportingCardGenerate')->name('teacher.reporting_card');
