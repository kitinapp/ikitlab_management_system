	...
	<div class="sidebar">
		...
		<ul class="nav-links">
			...
			<li class="nav-links-li <?php echo e(request()->is('teacher/reporting*') ? 'showMenu':''); ?>">
				...
				<ul class="sub-menu">
					<li><a class="<?php echo e((request()->is('teacher/reporting/create_modal')) ? 'active' : ''); ?>" href="<?php echo e(route('teacher.reporting.open_modal')); ?>"><span><?php echo e(get_phrase('Submit Report')); ?></span></a></li>
                    <li><a class="<?php echo e((request()->is('teacher/reporting')) ? 'active' : ''); ?>" href="<?php echo e(route('teacher.reporting')); ?>"><span><?php echo e(get_phrase('Report History')); ?></span></a></li>
...
<?php /**PATH C:\xampp\htdocs\Hemant\OfficeProjects\ikitlabManagementSystem\resources\views/teacher/navigation.blade.php ENDPATH**/ ?>