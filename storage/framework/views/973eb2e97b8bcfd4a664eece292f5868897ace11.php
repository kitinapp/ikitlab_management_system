...
<?php $__env->startSection('content'); ?>
    ...
    <div class="eForm-layouts">
        <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('teacher.reporting.update', ['id' => $reporting->id])); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="row fmb-14 justify-content-between align-items-center">
                ...
                <div class="col-sm-10 col-md-9 col-lg-10">
                    <input type="number" class="form-control eForm-control" id="present_students" name="present_students" value="<?php echo e($reporting->present_students); ?>" required>
                </div>
            </div>
            <div class="row fmb-14 justify-content-between align-items-center">
            ...
            <div class="row fmb-14 justify-content-between align-items-center">
                ...
                <div class="col-sm-10 col-md-9 col-lg-10">
                    <input type="text" class="form-control eForm-control" id="content_delivered" name="content_delivered" value="<?php echo e($reporting->content_delivered); ?>" required>
                </div>
            </div>
            <div class="row fmb-14 justify-content-between align-items-center">
                <label for="activity" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Activity')); ?></label>
                <div class="col-sm-10 col-md-9 col-lg-10">
                    <input type="text" class="form-control eForm-control" id="activity" name="activity" value="<?php echo e($reporting->activity); ?>">
                </div>
            </div>
            <div class="row fmb-14 justify-content-between align-items-center">
                <label for="class_starting_time" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Class Start Time')); ?></label>
                <div class="col-sm-5 col-md-5 col-lg-4">
                    <input type="time" class="form-control eForm-control" id="class_starting_time" name="class_starting_time" value="<?php echo e($reporting->class_starting_time); ?>" required>
                </div>
                <label for="class_ending_time" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Class End Time')); ?></label>
                <div class="col-sm-5 col-md-5 col-lg-4">
                    <input type="time" class="form-control eForm-control" id="class_ending_time" name="class_ending_time" value="<?php echo e($reporting->class_ending_time); ?>" required>
                </div>
            </div>
            <div class="row fmb-14 justify-content-between align-items-center">
                <label for="video" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Video URL')); ?></label>
                <div class="col-sm-10 col-md-9 col-lg-10">
                    <input type="text" class="form-control eForm-control" id="video" name="video" value="<?php echo e($reporting->video); ?>">
                </div>
            </div>
            <div class="row fmb-14 justify-content-between align-items-center">
            ...
            <div class="row">
                <div class="col-sm-10 offset-sm-2">
                    <button type="submit" class="btn-form"><?php echo e(get_phrase('Update Report')); ?></button>
                </div>
            </div>
        </form>
    </div>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Hemant\OfficeProjects\ikitlabManagementSystem\resources\views/teacher/reporting/edit_report.blade.php ENDPATH**/ ?>