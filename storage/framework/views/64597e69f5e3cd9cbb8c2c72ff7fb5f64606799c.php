      ...
      <div class="col-md-12">
        ...
        >
          <div class="d-flex flex-column">
            <h4><?php echo e(get_phrase('STEAM Topics')); ?></h4>
            <ul class="d-flex align-items-center eBreadcrumb-2">
              <li><a href="#"><?php echo e(get_phrase('Home')); ?></a></li>
              <li><a href="#"><?php echo e(get_phrase('STEAM')); ?></a></li>
              <li><a href="#"><?php echo e(get_phrase('Topic')); ?></a></li>
            </ul>
          </div>
          <div class="export-btn-area">
            <a href="javascript:;" class="export_btn" onclick="rightModal('<?php echo e(route('superadmin.steam_topic.open_modal')); ?>', '<?php echo e(get_phrase('Create STEAM Topic')); ?>')"><?php echo e(get_phrase('Create STEAM Topic')); ?></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="eSection-wrap">
            <div class="search-filter-area d-flex justify-content-md-between justify-content-center align-items-center flex-wrap gr-15">
              ...
              <!-- Export Button -->
              <?php if(count($steam_topic_lists) > 0): ?>
            ...
            <div class="table-responsive tScrollFix pb-2">
                  <table class="table eTable">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $steam_topic_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $steam_topic_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                <td><?php echo e($steam_topic_lists->firstItem() + $key); ?></td>
                                 <td><?php echo e($steam_topic_list->SteamSubject->steam->title); ?></td>
                                 <td><?php echo e($steam_topic_list->steam_subject->title); ?></td>
                                <td><?php echo e($steam_topic_list->title); ?></td>
                                <td class="text-start">
                                    <div class="adminTable-action">
                                        ...
                                        >
                                          ...
                                          <li>
                                            <a class="dropdown-item" href="javascript:;" onclick="confirmModal('<?php echo e(route('superadmin.steam_topic.delete', ['id' => $steam_topic_list->id])); ?>', 'undefined');"><?php echo e(get_phrase('Delete')); ?></a>
                                          </li>
                                        </ul>
                                    </div>
                                </td>
                ...
                <?php echo $steam_topic_lists->appends(request()->all())->links(); ?>
...
<?php echo $__env->make('superadmin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Hemant\OfficeProjects\ikitlabManagementSystem\resources\views/superadmin/curriculum/steam_topic/index.blade.php ENDPATH**/ ?>