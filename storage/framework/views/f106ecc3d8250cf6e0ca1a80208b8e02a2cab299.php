                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
                    <div class="d-flex flex-column">
                        ...
                        <ul class="d-flex align-items-center eBreadcrumb-2">
                            ...
                            <li><a href="#"><?php echo e(get_phrase('List')); ?></a></li>
                        </ul>
                    </div>
                    <div class="export-btn-area">
                        <a href="<?php echo e(route('teacher.reporting.open_modal')); ?>"
                           class="export_btn"><?php echo e(get_phrase('Create')); ?></a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-end filter-options" aria-labelledby="defaultDropdown">
                                ...
                                <form action="<?php echo e(route('superadmin.report')); ?>">
                                    <div class="filter-option d-flex flex-column">
                                        ...
                                        <?php endif; ?>
                                        <div>
                                            <label for="school_id" class="eForm-label"><?php echo e(get_phrase('School')); ?></label>
                                            <select class="form-select" name="school_id" id="school_id"
                                                    onchange="classWiseSection(this.value)" required>
                                                <option value=""><?php echo e(get_phrase('Select a School')); ?></option>
                                                <?php $__currentLoopData = $schools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $school): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($school->id); ?>"
                                                        <?php echo e($school_id == $school->id ? 'selected' : ''); ?>>
                                                        <?php echo e($school->title); ?></option>
                                    ...
                                    <div class="filter-button d-flex justify-content-end align-items-center">
                                        <a class="form-group">
                                            <button class="eBtn eBtn btn-primary"
                                                    type="submit"><?php echo e(get_phrase('Apply')); ?></button>
                                        </a>
                                    </div>
                                </form>
                            </div>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end eDropdown-menu-2">
                                    ...
                                    <li>
                                        <a class="dropdown-item" id="print" href="javascript:;"
                                           onclick="printableDiv('student_list')"><?php echo e(get_phrase('Print')); ?></a>
                                    </li>
                                </ul>
                            </div>
                        <?php endif; ?>
                    ...
                    <div class="row mb-4">
                        <div class="table-responsive">
                            <table class="table eTable">
                                <thead>
                                <tr>
                                    <th scope="col"><?php echo e(get_phrase('Total Completed Chapters')); ?></th>
                                    <th scope="col"><?php echo e(get_phrase('Total Chapters')); ?></th>
                                    <?php if(isset($_GET['school_id']) != ''): ?>
                                        <th scope="col">
                                            <?php echo e(get_phrase('Total Completed Chapters in') . ' ' . School::where('id', $_GET['school_id'])->value('title')); ?>
                                ...
                                <tr>
                                    <td>
                                        <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                            <div class="">
                                                <p>
                                                    <?php echo e($completed_chapter_in_all_schools); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table eTable eTable-2">
                            ...
                            <tr>
                                ...
                                <th scope="col"> <?php echo e(get_phrase('View')); ?> </th>
                                    ...
                                    <td>
                                        <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                            <div class="dAdmin_profile_name dAdmin_info_name">
                                                <p>
                                                    <span><?php echo e(get_phrase('Date')); ?>:</span>
                                                    <?php echo e(date('d-m-Y', strtotime($reporting->created_at))); ?>
                                        ...
                                        <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                            <div class="dAdmin_profile_name dAdmin_info_name">
                                                <p>
                                                    ...
                                                    <?php echo e($reporting->class->name); ?>
                                        ...
                                        <div class="dAdmin_profile d-flex align-items-center min-w-200px"s>
                                            <div class="dAdmin_profile_name dAdmin_info_name">
                                                <p>
                                                    ...
                                                    <span><?php echo e(get_phrase('Chapter')); ?>:</span>
                                                    <?php echo e($reporting->steamChapter->title); ?>

                                                    <br>
                                                    <?php echo $reporting->activity == null
                                                        ? ''
                                    ...
                                    <td>
                                        <div class="adminTable-action">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                    data-bs-target="<?php echo e('#school_id' . $reporting->id); ?>">
                                                <?php echo e(get_phrase('View')); ?>

                                                &#128065; 
                                            </button>
                                            <!-- Modal -->
                                            <div class="modal fade" id="<?php echo e('school_id' . $reporting->id); ?>"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="table-responsive">
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                                                                    <div class="dAdmin_profile_name dAdmin_info_name">
                                                                                        <p>
                                                                                            ...
                                                                                            <br>
                                                                                            <span><?php echo e(get_phrase('Day')); ?>:</span>
                                                                                            <?php echo e(Carbon::parse($reporting->created_at)->format('l')); ?>

                                                                                            <br>
                                                                                            <span><?php echo e(get_phrase('Start Time')); ?>:</span>
                                                                                            <?php echo e($reporting->class_starting_time ?? 'No Activity'); ?>

                                                                                            <br>
                                                                                            <span><?php echo e(get_phrase('End Time')); ?>:</span>
                                                                                            <?php echo e($reporting->class_ending_time); ?>
                                                                            ...
                                                                            <td>
                                                                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                                                                    <div class="dAdmin_profile_name dAdmin_info_name">
                                                                                        <p>
                                                                                            <span><?php echo e(get_phrase('Class')); ?>:</span>
                                                                                            <?php echo e($reporting->class_name); ?>

                                                                                            <br>
                                                                                            <span><?php echo e(get_phrase('Section')); ?>:</span>
                                                                                            <?php echo e($reporting->section->name); ?>

                                                                                            <br>
                                                                                            <span><?php echo e(get_phrase('Present Students')); ?>:</span>
                                                                                            <?php echo e($reporting->present_students); ?>

                                                                                            <br>
                                                                                            <span><?php echo e(get_phrase('Total Students')); ?>:</span>
                                                                                            <?php echo e($reporting->class->total_students); ?>
                                                                            ...
                                                                            <td>
                                                                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                                                                    <div class="dAdmin_profile_name dAdmin_info_name">
                                                                                        <p>
                                                                                            <span><?php echo e(get_phrase('STEAM')); ?>:</span>
                                                                                            <?php echo e($reporting->steam->title); ?>

                                                                                            <br>
                                                                                            <span><?php echo e(get_phrase('Subject')); ?>:</span>
                                                                                            <?php echo e($reporting->steamSubject->title); ?>

                                                                                            <br>
                                                                                            <span><?php echo e(get_phrase('Topic')); ?>:</span>
                                                                                            <?php echo e($reporting->steamTopic->title); ?>
                                                                                    ...
                                                                                    <?php if(is_array($photoArray) && count($photoArray) > 0): ?>
                                                                                        <marquee behavior="scroll" direction="left"
                                                                                            ...
                                                                                            <?php $__currentLoopData = $photoArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                <a target="_blank"
                                                                                                   href="<?php echo e(asset('public/assets/uploads/reporting-images/' . trim($photo))); ?>">
                                                                                                    <img class="mx-2" width="80" height="auto"
                                                                                                         src="<?php echo e(asset('public/assets/uploads/reporting-images/' . trim($photo))); ?>"
                                                                                                         alt="">
                                                                                                </a>
                                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                        </marquee>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p class="admin-tInfo">
                                                                        <?php echo e(get_phrase('Showing') . ' 1 - ' . count($reportings) . ' ' . get_phrase('from') . ' ' . $reportings->total() . ' ' . get_phrase('data')); ?>
                    ...
                    <tr>
                            ...
                            <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                ...
                                <div class="dAdmin_profile_name dAdmin_info_name">
                                    <p>
                                        ...
                                        <?php echo e($reporting->present_students . '/' . $reporting->total_students_from_class); ?>
                        ...
                        <td>
                            <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                <div class="dAdmin_profile_name dAdmin_info_name">
                                    <p>
                                        <span><?php echo e(get_phrase('Activity')); ?>:</span>
                                        <?php echo e($reporting->activity ?? 'No Activity'); ?>
