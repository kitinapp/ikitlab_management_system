...
<body>
	...
	<div class="sidebar">
		...
		<ul class="nav-links">
			...
			<li class="nav-links-li {{ request()->is('teacher/reporting*') ? 'showMenu':'' }}">
				<div class="iocn-link">
					<a href="#">
						<div class="sidebar_icon">
						...
						<span class="link_name">{{ get_phrase('Report') }}</span>
					</a>
					<span class="arrow">
	                  <svg
				...
				<ul class="sub-menu">
					<li><a class="{{ (request()->is('teacher/reporting/create_modal')) ? 'active' : '' }}" href="{{ route('teacher.reporting.open_modal') }}"><span>{{ get_phrase('Submit Report') }}</span></a></li>
                    <li><a class="{{ (request()->is('teacher/reporting')) ? 'active' : '' }}" href="{{ route('teacher.reporting') }}"><span>{{ get_phrase('Report History') }}</span></a></li>
