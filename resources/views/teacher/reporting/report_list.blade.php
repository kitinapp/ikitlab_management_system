                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
                    ...
                    <div class="export-btn-area">
                        <a href="{{ route('teacher.reporting.open_modal') }}"
                           class="export_btn">{{ get_phrase('Create Report') }}</a>
                    </div>
                </div>
            </div>
        </div>
                                            ...
                                            <ul
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="javascript:;"
                                                       onclick="largeModal('{{ route('teacher.reporting_card', ['id' => $reporting->id]) }}', '{{ get_phrase('Generate Report') }}')">{{ get_phrase('Generate Report') }}</a>
                                                </li>

                                                <li>
                                                    <a class="dropdown-item"
                                                       href="{{ route('teacher.reporting_edit_modal', ['id' => $reporting->id]) }}"
                                                       onclick="rightModal('{{ route('teacher.reporting_edit_modal', ['id' => $reporting->id]) }}', 'Edit Student')">{{ get_phrase('Edit') }}</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="javascript:;"
                                                       onclick="confirmModal('{{ route('teacher.reporting.delete', ['id' => $reporting->id]) }}', 'undefined');">{{ get_phrase('Delete') }}</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
