<div class="eoff-form">
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="{{ route('superadmin.create.steam_chapter') }}">
        @csrf
        <div class="form-row">
            <div class="fpb-7">
            ...
            <div class="fpb-7 pt-2">
                <button class="btn-form" type="submit">{{ get_phrase('Create Chapter') }}</button>
            </div>
    </form>
</div>
